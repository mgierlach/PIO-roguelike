...
public class ItemContainer {
    ...
    public void containerInformation(){
        for( int i=0; i < itemList.size(); i++ ) {
            System.out.println("Nazwa przedmiotu: " + itemList.get(i).name );
            System.out.println("Nazwa przedmiotu: " + itemList.get(i).price );
            System.out.println("Nazwa przedmiotu: " + itemList.get(i).id + "\n" );
        }
    }
